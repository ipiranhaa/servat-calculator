  ...
  ['d0a3'],
  {
    ...
    '23aj': function(e, t, n) {
      ...
      var Nt = { selectedMenu: 'report' },
        ...
        Lt = {
          orderList: [
            { id: 0, name: 'one', orders: [1111, 2222, 3333], total: 6666 },
            { id: 1, name: 'Two', orders: [1111.11, 2222.22, 3333.33], total: 6666.66 },
          ],
          editingOrder: { name: '', currentOrder: '', orders: [] },
        },
        qt = function(e, t) {
          switch (t.type) {
            case 'ADD_ORDER':
