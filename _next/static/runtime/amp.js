  ...
  \**************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
            ...
            var _temp2 = _catch(
              function() {
                return _promise.default
                  .resolve(
                    unfetch_1.default(''.concat(hotUpdatePath).concat(curHash, '.hot-update.json'))
                  )
                  .then(function(res) {
                    return _promise.default.resolve(res.json()).then(function(data) {
                      ...
                      var pageUpdated = (0, _keys.default)(data.c).some(function(mod) {
                        return (
                          mod.indexOf(
                            'pages'.concat(
                              curPage.substr(0, 1) === '/' ? curPage : '/'.concat(curPage)
                            )
                          ) !== -1 ||
                          mod.indexOf(
                            'pages'
                              .concat(curPage.substr(0, 1) === '/' ? curPage : '/'.concat(curPage))
                              .replace(/\//g, '\\')
                          ) !== -1
                        )
                      })
        ...
        var eventsource_1 = __webpack_require__(
          /*! ./dev-error-overlay/eventsource */ './node_modules/next/dist/client/dev-error-overlay/eventsource.js'
        )
