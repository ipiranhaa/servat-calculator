;(window.webpackJsonp = window.webpackJsonp || []).push([
  ['d0a3'],
  {
    ...
    '23aj': function(e, t, n) {
      ...
      var Pe = function(e) {
          ...
          return r.a.createElement(
            Te,
            null,
            0 === t.length && r.a.createElement(Re, null),
      ...
      var ot = function(e) {
        ...
        ht = de('SET_NEW_ORDERS'),
        mt = de('SUBMIT_NEW_ORDER_PRICE'),
        vt = de('SUBMIT_NEW_PERSON'),
        yt = Object(o.a)(K.a).withConfig({
          ...
          return r.a.createElement(
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(xt, { variant: 'h6', color: 'inherit' }, 'Add Order'),
                r.a.createElement(
                  m.a,
                  {
                    color: 'inherit',
            ...
            r.a.createElement(
              Ct,
              null,
              r.a.createElement(gt, { editingOrder: n, orderDispatch: o }),
              r.a.createElement(
                L.a,
                { dense: !1 },
                    ...
                    r.a.createElement(
                      ...
                      r.a.createElement(
                        P.a,
                        {
                          ...
                          onClick: function() {
                            return (function(e) {
                              var t = n.orders.filter(function(t, n) {
                                return n !== e
                              })
                              o(ht(t))
                            })(t)
      ...
      function It(e, t, n) {
        return (
          t in e
            ? Mt()(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 })
            : (e[t] = n),
          e
        )
      }
      function Nt(e) {
        for (var t = 1; t < arguments.length; t++) {
          var n = null != arguments[t] ? arguments[t] : {},
            a = Rt()(n)
          'function' == typeof Tt.a &&
            (a = a.concat(
              Tt()(n).filter(function(e) {
                return kt()(n, e).enumerable
              })
            )),
      ...
      var _t = { selectedMenu: 'orders' },
        jt = function(e, t) {
          switch (t.type) {
            case 'SET_MENU':
              return Nt({}, e, { selectedMenu: t.payload })
            default:
              return e
          }
        },
        At = { createDialog: { isOpen: !1 } },
        Dt = function(e, t) {
          switch (t.type) {
            case 'TOGGLE_CREATE_DIALOG':
              return Nt({}, e, { createDialog: { isOpen: t.payload } })
            default:
              return e
          }
        },
        Lt = n('dfwq'),
        qt = { orderList: [], editingOrder: { name: '', currentOrder: '', orders: [] } },
        Ft = function(e, t) {
          switch (t.type) {
            case 'ADD_ORDER':
              return Nt({}, e, {
                orderList: [].concat(Object(Lt.default)(e.orderList), [t.payload]),
              })
            case 'SET_NEW_ORDER_NAME':
              return Nt({}, e, { editingOrder: Nt({}, e.editingOrder, { name: t.payload }) })
            case 'SET_NEW_ORDER_PRICE':
              return Nt({}, e, {
                editingOrder: Nt({}, e.editingOrder, { currentOrder: t.payload }),
              })
            case 'SET_NEW_ORDERS':
              return Nt({}, e, { editingOrder: Nt({}, e.editingOrder, { orders: t.payload }) })
            case 'SUBMIT_NEW_ORDER_PRICE':
              return Nt({}, e, {
                editingOrder: Nt({}, e.editingOrder, {
                  currentOrder: qt.editingOrder.currentOrder,
                  orders: [].concat(Object(Lt.default)(e.editingOrder.orders), [
            ...
            case 'SUBMIT_NEW_PERSON':
              return Nt({}, e, {
                editingOrder: qt.editingOrder,
                orderList: [].concat(Object(Lt.default)(e.orderList), [
                  {
        ...
        Wt = { isIncludeServiceCharge: !0, isIncludeVat: !0, serviceCharge: 10, vat: 7 },
        Vt = function(e, t) {
          switch (t.type) {
            case 'SET_SERVICE_CHARGE_TOGGLE':
              return Nt({}, e, { isIncludeServiceCharge: t.payload })
            case 'SET_VAT_TOGGLE':
              return Nt({}, e, { isIncludeVat: t.payload })
            case 'SET_SERVICE_CHARGE':
              return Nt({}, e, { serviceCharge: t.payload })
            case 'SET_VAT':
              return Nt({}, e, { vat: t.payload })
            default:
              return e
          }
        },
        zt = de('SET_MENU', function(e) {
          switch (e) {
            case 1:
              return 'settings'
            case 2:
      ...
      var Bt = function() {
        var e = Object(a.useReducer)(jt, _t),
          t = Object(ne.default)(e, 2),
          n = t[0].selectedMenu,
          o = t[1],
          i = Object(a.useReducer)(Ft, qt),
          l = Object(ne.default)(i, 2),
          s = l[0],
          u = s.orderList,
          d = s.editingOrder,
          c = l[1],
          f = Object(a.useReducer)(Vt, Wt),
          p = Object(ne.default)(f, 2),
          h = p[0],
          m = p[1],
          v = Object(a.useReducer)(Dt, At),
        ...
        switch (n) {
          ...
          case 'report':
            ...
            break
          default:
            T = r.a.createElement(Pe, { orderList: u, orderDispatch: c })
        }
        return r.a.createElement(
          r.a.Fragment,
          null,
      ...
      t.default = function() {
        return r.a.createElement(te, null, r.a.createElement(Bt, null))
      }
    },
    '2DY1': function(e, t, n) {
      'use strict'
    ...
    OSyR: function(e, t, n) {
                ...
                return c.default.createElement(
                  ...
                  c.default.createElement(
                    ...
                    (0, r.default)(
                      ...
                      P,
                      {
                        onEntering: (0, y.createChainedFunction)(this.handleEntering, P.onEntering),
                      }
                    ),
                    c.default.createElement(
                      C.default,
      ...
      var R = (0, g.default)(T, { name: 'MuiPopover' })(O)
      t.default = R
    },
    P1BC: function(e, t, n) {
      'use strict'
            ...
            (0, s.default)(t, [
              {
                ...
                value: function() {
                  ...
                  var R = this.isControlled ? a : this.state.checked,
                    P = 'checkbox' === k || 'radio' === k
                  return f.default.createElement(
                    v.default,
                    (0, r.default)(
                      {
      ...
      e.exports = (function e(t) {
        ...
        function qe(e, t, r, o, i) {
          for (
            ...
            if (
              ...
              switch (b) {
                case j:
                  for (y = ($e = $e.trim()).charCodeAt(0), S = 1, Oe = ++U; U < Re; ) {
            ...
            switch (b) {
              ...
              case F:
                ...
                c === J
                  ...
                  Se * _e > 0 && He(Pe, $e, t, e, me, he, Ke.length, o, i, o),
                  (he = 1),
                  me++
                break
              case N:
        ...
        function Ve(e, t, n, a) {
          ...
          if (944 === f)
            return (function(e) {
              ...
              return (r = a + r + ';'), 1 === ge || (2 === ge && ze(r, 1)) ? P + r + r : r
            })(c)
          ...
          switch (f) {
            ...
            case 932:
              if (c.charCodeAt(4) === Y)
                switch (c.charCodeAt(5)) {
                  ...
                  case 115:
                    return P + c + I + c.replace('shrink', 'negative') + c
                  case 98:
                    return P + c + I + c.replace('basis', 'preferred-size') + c
                }
              return P + c + I + c + c
            case 964:
              return P + c + I + 'flex-' + c + c
            case 1023:
              ...
              return (
                ...
                P + 'box-pack' + u + P + c + I + 'flex-pack' + u + c
              )
            case 1005:
              return o.test(c) ? c.replace(r, ':' + P) + c.replace(r, ':' + M) + c : c
            case 1e3:
              switch (
            ...
            case 975:
              switch (
                ...
                case 102:
                  c =
                    c.replace(u, P + (f > 102 ? 'inline-' : '') + 'box') +
                    ';' +
                    c.replace(u, P + u) +
                    ';' +
                    c.replace(u, I + u + 'box') +
            ...
            case 938:
              if (c.charCodeAt(5) === Y)
                switch (c.charCodeAt(6)) {
                  case 105:
                    return (
                      (u = c.replace('-items', '')), P + c + P + 'box-' + u + I + 'flex-' + u + c
                    )
                  case 115:
                    return P + c + I + 'flex-item-' + c.replace(S, '') + c
                  default:
                    return (
                      P +
                      c +
            ...
            case 953:
              if (!0 === O.test(e))
                return 115 === (u = e.substring(e.indexOf(':') + 1)).charCodeAt(0)
                  ...
                  : c.replace(u, P + u) + c.replace(u, M + u.replace('fill-', '')) + c
              break
            case 962:
              if (
                ((c = P + c + (102 === c.charCodeAt(5) ? I + c : '') + c),
                n + a === 211 && 105 === c.charCodeAt(13) && c.indexOf('transform', 10) > 0)
              )
                return c.substring(0, c.indexOf(';', 27) + 1).replace(i, '$1' + P + '$2') + c
          }
          return c
        }
        function ze(e, t) {
        ...
        function $e(t, n) {
          ...
          var i,
            l = [Le]
          Se > 0 &&
            void 0 !== (i = He(Re, n, l, l, me, he, 0, 0, 0, 0)) &&
            'string' == typeof i &&
            (n = i)
          var s = qe(we, l, n, 0, 0)
          return (
      ...
      function h(e) {
        ...
        return l.default.createElement(f.default, { dense: b, alignItems: t }, function(e) {
          var i,
            ...
            R = (0, r.default)({ className: O, disabled: x }, S),
            P = h || 'li'
          return (
            n &&
              ((R.component = h || 'div'),
              (R.focusVisibleClassName = (0, s.default)(u.focusVisible, w)),
              (P = d.default)),
            T
              ? ((P = R.component || h ? P : 'div'),
                'li' === m &&
                  ('li' === P ? (P = 'div') : 'li' === R.component && (R.component = 'div')),
                l.default.createElement(
                  m,
                  (0, r.default)({ className: (0, s.default)(u.container, y) }, g),
                  l.default.createElement(P, R, v),
                  v.pop()
                ))
              : l.default.createElement(P, R, v)
          )
          ...
          Se = (function() {
            ...
            return (
              (e.prototype.generateAndInjectStyles = function(e, t) {
                ...
                if (R && n && 'string' == typeof r && t.hasNameForId(a, r)) return r
